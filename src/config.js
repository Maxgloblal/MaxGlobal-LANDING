...
/* ============================================================
 * PRODUCTOS
 * precioPublico es el dato. El precio de socio se calcula con
 * precioSocio(). Los PUNTOS son fijos: no varían con el descuento.
 * ⚠️ Las "presentacion" NO están confirmadas por el cliente.
 * ============================================================ */
